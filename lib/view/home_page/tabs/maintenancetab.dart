...
import '../../../utils/colorconstraints.dart';
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage(Imageconstraints.Strength),
                        fit: BoxFit.cover)),
              ),
              SizedBox(
                height: 10,
              ...
              ListView.separated(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    // Workout name
                                    Text(
                                      Dummydb.strengthWorkouts[index]
                                          ["workoutName"],
                                      style: TextStyle(
                                        fontSize: 20,
                                    ...
                                    SizedBox(height: 4),
                                    Text(
                                      Dummydb.strengthWorkouts[index]["reps"] ??
                                          "",
                                      style: TextStyle(
                                        fontSize: 16,
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      Dummydb.strengthWorkouts[index]["sets"],
                                      style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                        color: Colors.black87,
                ...
                itemCount: Dummydb.strengthWorkouts.length,
              )
            ],
          ),
        ),
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => GymWorkoutScreen(
                      workouts: Dummydb.strengthWorkouts,
                    ),
                  ),
                );
              } else {
